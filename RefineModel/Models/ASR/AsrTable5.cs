...
{
    public class AsrTable5 : AsrBase
    {
        ...
        public string? AsrTable5Energies { get; set; }

        [Display(Name = "مطفأ(نعم/لا)")]
        public string? AsrTable5Off { get; set; }

        [Display(Name = "طاقة التشغيل")]
        public int? AsrTable5OperationPower { get; set; }

        [Display(Name = "سبب التطفئة")]
        public string? AsrTable5Reasonforturningoff
        { get; set; }
