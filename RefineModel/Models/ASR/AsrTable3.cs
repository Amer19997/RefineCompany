...
{
    public class AsrTable3 : AsrBase
    {
        ...
        [Display(Name = "نغذية")]
        public string? AsrTable3Supply { get; set; }

        [Display(Name = "المنتجات")]
        public string? AsrTable3Products { get; set; }

        [Display(Name = "الرصيد")]
        public int? AsrTable3Balance { get; set; }
        [Display(Name = "التدفيعات")]
        public int? AsrTable3Installments { get; set; }
        [Display(Name = "الاستلامات")]
        public int? AsrTable3Receipts { get; set; }
        //   [Key]
